...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-32wpo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-32wpo.containers.anotherwebservice.com/
...
```
git clone git@github.com:sam100155/container-32wpo.git
cd container-32wpo
```
